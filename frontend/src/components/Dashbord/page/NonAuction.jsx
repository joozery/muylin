...
const NonAuction = () => {
  const initialData = [
    { no: 1, plate: 'กท 1234', total: calculateTotal('กท1234'), price: '400,000 บาท', status: 'พร้อมขาย' },
    { no: 2, plate: 'ภม 5678', total: calculateTotal('ภม5678'), price: '350,000 บาท', status: 'จองแล้ว' },
  ];
