...
const GraphicVanPlate = () => {
  ...
  const fetchPlates = async () => {
    setLoading(true);
    try {
      const response = await fetch(`${API_URL}/plates_graphic_van`);
  ...
  const handleAddPlate = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/addPlate/plates_graphic_van`, {
        method: "POST",
  ...
  const handleStatusChange = async (id, newStatus) => {
    ...
    try {
      const response = await fetch(
        `${API_URL}/updateStatus/plates_graphic_van/${id}`,
        {
          method: "PUT",
          headers: { "Content-Type": "application/json" },
  ...
  const handleDeletePlate = async (id, plate) => {
    ...
    if (result.isConfirmed) {
      ...
      try {
        const response = await fetch(
          `${API_URL}/deletePlate/plates_graphic_van/${id}`,
          { method: "DELETE" }
        );
  ...
  const handleEdit = async (formModal) => {
    ...
    try {
      const response = await fetch(
        `${API_URL}/updatePlate/plates_graphic_van/${formModal.id}`,
        {
          method: "PUT",
          headers: { "Content-Type": "application/json" },
...
export default GraphicVanPlate;
