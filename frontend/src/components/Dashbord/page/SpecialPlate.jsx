...
const SpecialPlate = () => {
  const initialData = [
    { no: 1, plate: 'สวย 9999', total: calculateTotal('สวย9999'), price: '1,200,000 บาท', status: 'ขายแล้ว' },
    { no: 2, plate: 'รวย 8888', total: calculateTotal('รวย8888'), price: '990,000 บาท', status: 'พร้อมขาย' },
    { no: 3, plate: 'เฮง 7777', total: calculateTotal('เฮง7777'), price: '850,000 บาท', status: 'จองแล้ว' },
  ];
