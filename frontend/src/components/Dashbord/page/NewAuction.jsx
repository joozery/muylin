...
const NewAuction = () => {
  ...
  const handleAddPlate = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/addPlate/plates_new`, {
        method: "POST",
  ...
  const handleStatusChange = async (id, newStatus) => {
    ...
    try {
      const response = await fetch(`${API_URL}/updateStatus/plates_new/${id}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
    ...
    if (result.isConfirmed) {
      ...
      try {
        const response = await fetch(
          `${API_URL}/deletePlate/plates_new/${id}`,
          { method: "DELETE" }
        );
  ...
  const handleEdit = async (formModal) => {
    ...
    try {
      const response = await fetch(
        `${API_URL}/updatePlate/plates_new/${formModal.id}`,
        {
          method: "PUT",
          headers: { "Content-Type": "application/json" },
